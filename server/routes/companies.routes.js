const { getAllCompanies, getOneCompany, createCompany, updateCompany, deleteCompany, addProductCompany, getOneCompanyUrl } = require('../controllers/companies.controllers');

module.exports = (app) => {
    app.get('/api/companies', getAllCompanies);
    app.get('/api/companies/:id', getOneCompany);
    app.get('/api/companies/url/:nameurlcompany', getOneCompanyUrl);
